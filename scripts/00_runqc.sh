...
stats1=$1
stats2=$1
file1+="_R1_001.fastq.gz" # ST-8B_S2_L001_R1_001.fastq.gz
...
if test -f $file1; then
    ...
    fastp --overrepresentation_analysis --detect_adapter_for_pe --trim_poly_g \
	  --cut_mean_quality 20 --trim_poly_x --length_required 30 --thread 8 \
    ...
    fastq_quality_trimmer -Q 33 -t 30 -l 60 -i $fastp1c -o $trim1 -v  $stats1 &
    echo "~/FASTQC/fastq_quality_trimmer -Q 33 -t 30 -l 60 -i $fastp1c -o $trim1 -v  $stats1"
    echo "~/FASTQC/fastq_quality_trimmer -Q 33 -t 30 -l 60 -i $fastp2c -o $trim2 -v  $stats2"
    fastq_quality_trimmer -Q 33 -t 30 -l 60 -i $fastp2c -o $trim2 -v  $stats2
